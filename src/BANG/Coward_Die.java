...
/**
 * This class is used for anyone rolling a coward die
 * @author Zach Carrillo
 */
public class Coward_Die extends Die {
    /**This String holds what each face is of the die */
    public String [] faces = {"One","Two-Beers","Dynamite","Arrow","Broken-Arrow","Beer"};
    ...
    public void checkFace() {
        if(face == 0) {
            ...
            GameController.PlayerActions[3]++;
            System.out.println(faces[face]);
        }
        else if(face == 5) {
            GameController.PlayerActions[4]++;
